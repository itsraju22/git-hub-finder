const About = () => {
    return (
        <div className="about text-center">
            <div>
                <h1>About</h1>
                <p>This is a application to search GitHub Users</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>
                    You can check the source code on my github repo <a className="external" href="https://github.com/itsraju22/git-hub-finder" target="_blank" rel="noreferrer">@https://github.com/itsraju22/git-hub-finder</a>
                </p>
